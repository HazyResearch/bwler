...
# CUDA_VISIBLE_DEVICES=3 python -m src.experiments.pdes.simple.wave --c 2 --beta 5 --n_epochs 1000000 --eval_every 50 --sample_type standard --n_layers 3 --hidden_dim 64 --activation tanh --method ssbroyden --model piratenet --seed 0
