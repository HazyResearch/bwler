...
#SBATCH -o slurm_burgers_mlpinterp_temporal.out
#SBATCH --job-name burgers_mlpinterp_temporal
...
CUDA_VISIBLE_DEVICES=3 python -m src.experiments.pdes.benchmarks.burgers \
    --model mlpinterp_temporal \
    --n_t 641 --n_x 641 \
    --n_layers 3 --hidden_dim 32 --activation tanh \
    --method ssbroyden \
    --n_epochs 100000 \
    --eval_every 50 \
    --seed 0 \
