...
#CUDA_VISIBLE_DEVICES=$DEVICE python -m src.experiments.pdes.simple.reaction --rho 5 --n_layers 3 --hidden_dim 64 --activation tanh --n_epochs $N_EPOCHS --method lssbroyden --sample_type standard --model mlp --eval_every 2
...
#CUDA_VISIBLE_DEVICES=$DEVICE python -m src.experiments.pdes.simple.reaction --rho 5 --n_t 121 --n_x 121 --n_epochs $N_EPOCHS --method ssbroyden --sample_type standard --model polynomial --eval_every 50
